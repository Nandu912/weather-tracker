...
This app is deployed using [Vercel](https://vercel.com). You can view the live app here: [Live Weather App](https://weather-tracker-h5bwfuqrb-nandanas-projects-a4b15cb4.vercel.app).
